...
async function initChatHistory() {
    try {
        ...
        console.log('✅ Conectado a la base de datos solucnet_auth_system');
        ...
        console.log('✅ Tabla chat_messages creada/verificada');
        ...
        console.log('✅ Tabla chat_sync_status creada/verificada');

        await conexion.end();
        console.log('✅ Tablas de historial de chat inicializadas correctamente');
    } catch (error) {
